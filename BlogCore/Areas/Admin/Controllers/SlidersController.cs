...
namespace BlogCore.Areas.Admin.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        public SlidersController(IContainerWork contenedorTrabajo,
        ...
        public IActionResult Edit(Slider slider)
        {
            
            {
                ...
                if (archivos.Count() > 0)
                {
                    ...
                    var rutaImagen = Path.Combine(rutaPrincipal, sliderDdesdeBd.UrlImage.TrimStart('\\'));
                ...
                else
                {
                    ...
                    slider.UrlImage = sliderDdesdeBd.UrlImage;
                }
        ...
        public IActionResult Delete(int id)
        {
            ...
            var rutaImagen = Path.Combine(rutaDirectorioPrincipal, sliderDesdeBd.UrlImage.TrimStart('\\'));
            if (System.IO.File.Exists(rutaImagen))
            {
                System.IO.File.Delete(rutaImagen);
            }
